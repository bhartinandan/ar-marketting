"""
Django settings for armarketting project.
...
SECRET_KEY = 'django-insecure-1t5ef9wwv728xhh=9t27$^1oc(gu=w08f8@dru_@4l%2m-p*4$'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/var/log/django/error.log',  # Create this path
        },
    },
    'loggers': {
        'django': {
...
ROOT_URLCONF = 'armarketting.urls'
...
WSGI_APPLICATION = 'armarketting.wsgi.application'
